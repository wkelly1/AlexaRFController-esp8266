...
void turnOn(String deviceId) {
  ...
  {  
    ...
    mySwitch.send(""); //Enter binary code for first device on
  ...
  { 
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
    mySwitch.send(""); //Enter binary code for second device on
  ...
  { 
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
    mySwitch.send(""); //Enter binary code for third device on
...
void turnOff(String deviceId) {
   if (deviceId == "") // Device ID of first device off
   {  
     Serial.print("Turn off Device ID: "); 
     Serial.println(deviceId);
     mySwitch.send(""); //Enter binary code for first device off
     digitalWrite(BUILTIN_LED, HIGH);
   }
   else if (deviceId == "") // Device ID of second device off
   { 
     Serial.print("Turn off Device ID: ");
     Serial.println(deviceId);
     mySwitch.send(""); //Enter binary code for second device off
  }
     else if (deviceId == "") // Device ID of third device off
   { 
     Serial.print("Turn off Device ID: ");
     Serial.println(deviceId);
     mySwitch.send(""); //Enter binary code for third device off
